            ...
            <div class="row match-height">
                <div class="col-12">
                    <div class="container-fluid">
                        ...
                        <?php
                            if(isset($_POST['adjustmentid']))
                            {
                                ...
                                if(mysqli_num_rows($adjustment_query_run) > 0)
                                {
                                    ...
                                    $cost_adjustment_query = "SELECT * FROM price_adjustment WHERE adjustment_id = $adjustment_id AND adjustment_type= 1";
                                    $cost_adjustment_query_run = mysqli_query($connect, $cost_adjustment_query);
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        if(mysqli_num_rows($cost_adjustment_query_run) > 0)
                                        {
                                            $i = 1;
                                            while($cost_adjustment = mysqli_fetch_assoc($cost_adjustment_query_run))
                                            {
                                                $item_id = $cost_adjustment['item_id'];
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">RM <?= number_format($cost_adjustment['adjustment_amount'], 2); ?></td>
                                                </tr>
                                                <?php
                                            }
                                        }
                        ...
                        <?php
                                ?>
                                <a href="cost.php" class="btn btn-secondary mt-4">Back to Cost Adjustments</a>
                                <?php

            ...
            <div class="row match-height">
                <div class="col-12">
                    <div class="container-fluid">
                        <h2 class="mb-4">Inventory Adjustments</h2>
                        <a href="inventory_adjust.php" class="btn btn-primary mb-4">Add Adjustment</a>
                        <table class="table table-striped fs-5" width="100%" id="adjustmentsTable">
                            ...
                            <tbody>
                                <?php
                                $adjustments_query = "SELECT * FROM adjustment WHERE type = 0";
                                    ...
                                    while($adjustment = mysqli_fetch_assoc($adjustments_result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="view_inventory_adjustment.php" method="POST">
...
// Detect form submissions within the application
...
// Detect page load to reset the flags
window.addEventListener('load', function () {
    isNavigating = false;
    isReloading = false;
});

// Detect F5 or Ctrl+R for page reload
...
// Detect reload through browser button
window.addEventListener('beforeunload', function (e) {

...
<head>
    ...
    <title>View Price Adjustments</title>
            ...
            <div class="row match-height">
                <div class="col-12">
                    <div class="container-fluid">
                        <h2 class="mb-4">Price Adjustments</h2>
                        <a href="price_adjust.php" class="btn btn-primary mb-4">Add Adjustment</a>
                        <table class="table table-striped fs-5" width="100%" id="adjustmentsTable">
                            ...
                            <tbody>
                                <?php
                                $adjustments_query = "SELECT * FROM adjustment WHERE type = 1";
                                    ...
                                    while($adjustment = mysqli_fetch_assoc($adjustments_result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <form action="view_price_adjustment.php" method="POST">

            ...
            <div class="row match-height">
                <div class="col-12">
                    <div class="container-fluid">
                        ...
                        <?php
                            if(isset($_POST['adjustmentid']))
                            {
                                ...
                                if(mysqli_num_rows($adjustment_query_run) > 0)
                                {
                                    ...
                                    $inv_adjustment_query = "SELECT * FROM price_adjustment WHERE adjustment_id = $adjustment_id";
                                        ...
                                        if(mysqli_num_rows($inv_adjustment_query_run) > 0)
                                        {
                                            ...
                                            while($inv_adjustment = mysqli_fetch_assoc($inv_adjustment_query_run))
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">RM <?= number_format($inv_adjustment['adjustment_amount'], 2); ?></td>
                                                </tr>
                                                <?php
                                            }
                                        }
                        ...
                        <?php
                                ?>
                                <a href="price.php" class="btn btn-secondary mt-4">Back to Price Adjustments</a>
                                <?php
